...
<GalleryComposable>
  ...
  <ImageWithCaptionComposable src={"/assets/wahoo_fitness/loupe.jpeg"} span={1}>
    ...
    >bluetooth enabled prototype</a>
    in front of prototyping nerds in Framer Loupe, Amsterdam, 2019.
  ...
  <ImageWithCaption
    ...
    caption="ProRides are immersive ride experiences where we put you right in the middle of the racing action! "
    span={1}
  />
  <ImageWithCaption
