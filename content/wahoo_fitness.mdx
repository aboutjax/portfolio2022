...
coverImages:
  [
    "/assets/wahoo_fitness/kickr_bike.webp",
    "/assets/wahoo_fitness/onboarding.webp",
    "/assets/wahoo_fitness/systm-06.jpg",
    "/assets/wahoo_fitness/elemnt_1.webp",
    "/assets/wahoo_fitness/loupe_3.jpeg",
  ]
ogImage:
...
<GalleryComposable>
  ...
  />
  <ImageWithCaption
    src={"/assets/wahoo_fitness/loupe_3.jpeg"}
    alt="Serving SYSTM Training Program"
...
<GalleryComposable>
  <ImageWithCaption
    src={"/assets/wahoo_fitness/systm-01.jpg"}
    alt="SYSTM"
    caption="SYSTM training platform"
    span={1}
  />
  <ImageWithCaption
    src={"/assets/wahoo_fitness/systm-02.jpg"}
    alt="SYSTM"
    caption="SYSTM training platform"
    span={1}
  />
  <ImageWithCaption
    src={"/assets/wahoo_fitness/systm-05.jpg"}
    alt="SYSTM"
    caption="SYSTM training platform"
    span={1}
  />
  <ImageWithCaption
    src={"/assets/wahoo_fitness/systm-06.jpg"}
    alt="SYSTM"
    caption="SYSTM training platform"
    span={1}
  />
  <ImageWithCaption
    src={"/assets/wahoo_fitness/systm-03.jpg"}
    alt="SYSTM"
    caption="SYSTM training platform"
    span={1}
  />
  <ImageWithCaption
    src={"/assets/wahoo_fitness/systm-04.jpg"}
    alt="SYSTM"
    caption="SYSTM training platform"
    span={1}
  />
